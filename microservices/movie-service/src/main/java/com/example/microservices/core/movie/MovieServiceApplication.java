...
public class MovieServiceApplication {
	...
	public void initIndicesAfterStartup() {
		...
		ReactiveIndexOperations indexOps = mongoTemplate.indexOps(MovieEntity.class);
		resolver.resolveIndexFor(MovieEntity.class).forEach(e -> indexOps.ensureIndex(e).block());
	}
